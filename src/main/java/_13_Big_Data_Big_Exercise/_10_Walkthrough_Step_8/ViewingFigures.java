package _13_Big_Data_Big_Exercise._10_Walkthrough_Step_8;
...
public class ViewingFigures {
    public static void main(final String[] args) {
        ...
        try (final JavaSparkContext javaSparkContext = new JavaSparkContext(sparkConf)) {
            ...
            final JavaPairRDD<Integer, ? extends Number> step8 = step7.mapValues(value -> {
                if (value > 0.9) {
                    return 10L;
                }
            ...
            step8.foreach(toPrint -> System.out.println(toPrint));
        }
