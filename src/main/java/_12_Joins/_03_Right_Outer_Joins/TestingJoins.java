package _12_Joins._03_Right_Outer_Joins;
...
public class TestingJoins {
    public static void main(final String[] args) {
        ...
        try {
            ...
            final JavaPairRDD<Integer, Tuple2<Optional<Integer>, String>> joinedRDD = visits.rightOuterJoin(users);
            joinedRDD.foreach(result -> System.out.println("user " + result._2._2.toUpperCase() + " visited " + result._2._1.orElse(0) + " times."));
