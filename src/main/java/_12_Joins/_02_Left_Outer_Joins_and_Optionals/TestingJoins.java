package _12_Joins._02_Left_Outer_Joins_and_Optionals;
...
public class TestingJoins {
    public static void main(final String[] args) {
        ...
        try {
            ...
            final JavaPairRDD<Integer, Tuple2<Integer, Optional<String>>> joinedRDD = visits.leftOuterJoin(users);
            //joinedRDD.foreach(result -> System.out.println(result._2._2.get().toUpperCase()));                     // java.lang.NullPointerException
            joinedRDD.foreach(result -> System.out.println(result._2._2.orElse("no name").toUpperCase()));
